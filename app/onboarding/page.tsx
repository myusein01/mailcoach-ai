...
<table cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
  <tr>
    ...
    <td style="font-size:12.5px; color:#2B2B2B; vertical-align:middle;">
      ${escapeHtml(phone)}
    </td>
  </tr>
</table>
...
<table cellpadding="0" cellspacing="0" style="border-collapse:collapse; margin-top:2px;">
  <tr>
    ...
    <td style="font-size:12.5px; vertical-align:middle;">
      <a
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setLogoHeight(
          typeof p?.logo_height === "number" ? p.logo_height : 70
        );
